...
namespace Microsoft.VisualStudio.Editor.Razor
{
    internal class DefaultVisualStudioRazorParser : VisualStudioRazorParser, IDisposable
    {
        ...
        private readonly List<CodeDocumentRequest> _syntaxTreeRequests;
            ...
            VisualStudioCompletionBroker completionBroker)
        {
            ...
            _syntaxTreeRequests = new List<CodeDocumentRequest>();
        ...
        public override Task<RazorCodeDocument> GetLatestCodeDocumentAsync(ITextSnapshot atOrNewerSnapshot, CancellationToken cancellationToken = default)
        {
