...
{
    internal class DefaultFeedbackLogWriter : FeedbackLogWriter, IDisposable
    {
        ...
        public DefaultFeedbackLogWriter(FeedbackLogDirectoryProvider feedbackLogDirectoryProvider)
        {
